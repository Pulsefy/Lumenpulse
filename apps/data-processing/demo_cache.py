...
def demo_caching():
    ...
    print(
        f"  Positive: {result1.positive}, Negative: {result1.negative}, Neutral: {result1.neutral}"
    )
    ...
    print(
        f"  Positive: {result2.positive}, Negative: {result2.negative}, Neutral: {result2.neutral}"
    )
