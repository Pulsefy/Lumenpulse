...
const RAW_EVENT_MAP: Record<string, CanonicalEventType> = {
  ...
  MintedEvent: CanonicalEventType.TOKEN_MINTED,
  TransferEvent: CanonicalEventType.TOKEN_TRANSFERRED,
  FreezeEvent: CanonicalEventType.TOKEN_FREEZED,
  UnfreezeEvent: CanonicalEventType.TOKEN_UNFROZEN,
  ApprovalEvent: CanonicalEventType.TOKEN_APPROVED,
  ...
  ContributorDeregisteredEvent: CanonicalEventType.CONTRIBUTOR_DEREGISTERED,
  StreamCancelledEvent: CanonicalEventType.STREAM_CANCELLED,
  EmergencyStopEvent: CanonicalEventType.STREAM_EMERGENCY_STOPPED,
  VaultPauseEvent: CanonicalEventType.ADMIN_PAUSED,
  ConfigUpdatedEvent: CanonicalEventType.PROJECT_CONFIG_UPDATED,
