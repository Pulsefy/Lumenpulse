  ...
  private seedRounds() {
    ...
    const activeRound: RoundRecord = {
      ...
      contributions: new Map([
        [1, new Map([
          ['GA5ZSEJYB37JRC5AVCIA5MOP4RHTM335X2KGX3IHOJAPP5RE34K4KZVN', 15000000000n], // 1,500 XLM
          ['GBK37RY6M2X4M74H5QZ3HY2A3EHL73LIV52AHP4R6Q3I4G4R4KZV2OTHER1', 5000000000n] // 500 XLM
        ])],
        [2, new Map([
          ['GA5ZSEJYB37JRC5AVCIA5MOP4RHTM335X2KGX3IHOJAPP5RE34K4KZVN', 8000000000n], // 800 XLM
          ['GBK37RY6M2X4M74H5QZ3HY2A3EHL73LIV52AHP4R6Q3I4G4R4KZV2OTHER2', 12000000000n] // 1,200 XLM
        ])],
        [3, new Map([
          ['GBK37RY6M2X4M74H5QZ3HY2A3EHL73LIV52AHP4R6Q3I4G4R4KZV2OTHER3', 2000000000n] // 200 XLM
        ])]
      ]),
    ...
    const endedRound: RoundRecord = {
      ...
      contributions: new Map([
        [2, new Map([
          ['GA5ZSEJYB37JRC5AVCIA5MOP4RHTM335X2KGX3IHOJAPP5RE34K4KZVN', 45000000000n], // 4,500 XLM
          ['GBK37RY6M2X4M74H5QZ3HY2A3EHL73LIV52AHP4R6Q3I4G4R4KZV2OTHER1', 15000000000n] // 1,500 XLM
        ])],
        [4, new Map([
          ['GBK37RY6M2X4M74H5QZ3HY2A3EHL73LIV52AHP4R6Q3I4G4R4KZV2OTHER3', 30000000000n] // 3,000 XLM
        ])]
      ]),
