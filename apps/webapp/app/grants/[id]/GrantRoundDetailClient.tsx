...
interface GrantRoundDetailClientProps {
  roundId: string;
  initialData?: RoundSummary | null;
}

export default function GrantRoundDetailClient({ roundId, initialData }: GrantRoundDetailClientProps) {
  const [summary, setSummary] = useState<RoundSummary | null>(initialData ?? null);
